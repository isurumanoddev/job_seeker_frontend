      ...
      >
          ...
          <div className="grid gap-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <DeleteOutlined className="text-red-600 text-2xl hover:text-red-600 cursor-pointer" />
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div>Steve Jobs</div>
        ...
        <Form.Item style={{ marginBottom: 0 }}>
          <div className=" flex justify-end">
            <Button className="mr-3 w-full bg-red-600 text-white" onClick={() => handleCancel()}>
              Cancel
            </Button>
            <Button
              className="w-full"
