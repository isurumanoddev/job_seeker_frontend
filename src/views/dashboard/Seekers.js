...
function Seekers() {
  ...
  async function deleteItem() {
    const apiResponse = await DeleteSeekersApi(selectItem.id);
    if (
    ...
    <>
      <>
        <Tooltip placement="left" title={"Add categories"}>
          ...
          >Add Seeker<PlusOutlined /></Button>
        </Tooltip>
      </>
    </>
  );

  const left = <div className="pri-font text-xl font-semibol">Seekers</div>;
  return (
    <>
