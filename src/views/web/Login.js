...
function Login() {
  ...
  return (
    <div
      className="h-screen flex w-full  items-center justify-center bg-gradient-to-r from-purple-800 via-indigo-700 to-blue-500  text-white "
    ...
    >
      <div className="w-full max-w-lg p-3">
        ...
        <Card
        className="bg-gray-200 w-180 border-0 shadow-lg rounded-lg overflow-hidden"
          style={{
            borderColor: "#e5e7eb",
            cursor: "pointer",
          }}
        >
          <div className="text-5xl pri-font text-center mb-1">Welcome</div>
          <div className="text-center text-xl mb-6 text-gray-500">
